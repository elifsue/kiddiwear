...
export default function OfferSentCancelled() {
        ...
        <div className="flex flex-1 border-b border-black">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
              {/* OFFER SENT bubble (from user — right side) — CANCELLED */}
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Chat messages — only first offer bubble (Cancelled) */}
          <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
            {/* OFFER SENT bubble (from user — right side) — CANCELLED */}
            <div className="flex gap-2 ml-auto flex-row-reverse">
              {isHifi ? (
