...
export default function OfferSentCounter() {
        ...
        <div className="flex flex-1 border-b border-black">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
              {/* 1st OFFER SENT bubble (from user — right side) — DECLINED */}
              ...
              {/* 2nd COUNTER OFFER from seller (left side) — PENDING */}
    ...
    >
      ...
      >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0 overflow-hidden">
                  ...
                  <p
                    ...
                    style={{ color: isHifi ? DS.onSurfaceVariant : "#6b7280" }}
                  >
                    Counter offer received: &pound;10.00
                  </p>
                </div>
              </div>
              <div
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Item banner — bigger 2nd line text in mid/hi-fi */}
          <div
              ...
              <div className="w-[360px]">
                ...
                >
                  ...
                  <div className="border border-gray-200 rounded bg-gray-50 px-3 py-2 mb-3">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      Thanks for your offer! I can&apos;t go as low as &pound;8
                      but I&apos;d be happy to do &pound;10. It&apos;s barely
                      been worn.
                    </p>
                  </div>
                  <div className="flex flex-col gap-2">
