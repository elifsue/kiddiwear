...
import { RoyalMailIcon } from "@/icons/DeliveryIcons";
                ...
                <div className="border border-black p-5 mb-5">
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      <div
                        key={i}
                        className={`border p-4 flex items-center justify-between ${opt.selected ? "border-2 border-black" : "border-black"}`}
                      >
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div
                      key={opt.method}
                      className={`rounded p-4 flex items-center justify-between transition-colors ${opt.selected ? "border-2 border-gray-800 bg-gray-50" : "border border-gray-200 hover:border-gray-300"}`}
                    >
                      <div className="flex items-center gap-3">
                        <RadioButton selected={opt.selected} />
