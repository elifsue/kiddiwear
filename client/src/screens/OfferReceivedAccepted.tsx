...
export default function OfferReceivedAccepted() {
      ...
      <div className="flex flex-col min-h-[900px]">
        ...
        <div className="flex flex-1 border-b border-black">
          ...
          <div className="flex-1 flex flex-col">
            ...
            {/* Item banner — no CTA buttons (seller's own item) */}
            <Link
            ...
            {/* Chat messages — offer accepted */}
            <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
              {/* OFFER RECEIVED bubble (from buyer — left side) — ACCEPTED */}
                ...
                <div className="w-[360px]">
                  <div className="border border-black p-4 bg-white">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <BadgeLabel variant="positive" className="ml-auto">
                        Accepted
                      </BadgeLabel>
                    </div>
              ...
              <div className="w-[360px]">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: isHifi ? DS.onSurfaceVariant : "#4b5563" }}
                  >
