...
export default function OfferReceivedCounter() {
      ...
      <div className="flex flex-col min-h-[900px]">
        ...
        <div className="flex flex-1 border-b border-black">
          ...
          <div className="flex-1 flex flex-col">
            ...
            {/* Item banner — stacked text in lo-fi, no CTA buttons for screen 35 */}
            <Link
              to={ROUTES.PRODUCT_DETAIL_BUY}
              className="flex items-center gap-3 px-4 py-2.5 border-b border-black bg-white hover:bg-gray-50 cursor-pointer"
            >
              <ImagePlaceholder
            ...
            <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
              {/* 1st OFFER RECEIVED bubble (from buyer — left side) — DECLINED */}
                ...
                <div className="w-[360px]">
                  <div className="border border-black p-4 bg-white">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <BadgeLabel variant="negative" className="ml-auto">
                        Declined
                      </BadgeLabel>
                    </div>
              ...
              {/* 2nd COUNTER OFFER from user/seller (right side) — PENDING */}
    ...
    >
      ...
      >
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  <Avatar
                    size="sm"
                    src={chatListPhotosOR[i % chatListPhotosOR.length]}
                    alt={c.name}
                  />
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Item banner — bigger 2nd line text in mid/hi-fi, no CTA buttons for screen 35 */}
          <Link
            to={ROUTES.PRODUCT_DETAIL_BUY}
          ...
          <div className="flex-1 p-4 overflow-y-auto flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              ...
              <div className="w-[360px]">
                <div
                  className="border rounded-lg rounded-tl-none p-4 bg-white"
                  style={{
                ...
                >
                  ...
                  <div className="border border-gray-200 rounded bg-gray-50 px-3 py-2">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      Would you take &pound;6.00? I can pay straight away. My
                      son needs it for school next week!
                    </p>
                  </div>
                </div>
                <p
              ...
              <div className="w-[360px]">
                ...
                >
                  ...
                  <div className="border border-gray-200 rounded bg-gray-50 px-3 py-2 mb-3">
                    <p className="text-xs text-gray-600 leading-relaxed">
                      I appreciate the offer but &pound;6 is too low. How about
                      &pound;8? It&apos;s in great condition and barely worn.
                    </p>
                  </div>
                  <ActionButton variant="outlined" full>
                    Cancel Offer
